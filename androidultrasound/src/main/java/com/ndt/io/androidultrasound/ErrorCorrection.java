...
public class ErrorCorrection {
    ...
    public static final GenericGF DATA_MATRIX_FIELD_16 = GenericGF.AZTEC_PARAM;
    ...
    private static byte[] rs16Encode(int[] ints){
        ...
        ReedSolomonEncoder encoder = new ReedSolomonEncoder(DATA_MATRIX_FIELD_16);
    ...
    public static int rs16DecodeToaInt(byte[] bits) {
        ...
        ReedSolomonDecoder decoder = new ReedSolomonDecoder(DATA_MATRIX_FIELD_16);
        try {
